...
urlpatterns = [
    ...
    path('edit-disease2bscan-vector/<int:scan_fid>/', disease2bscan_update_view, name='disease2bscan_update_page'),
    path('edit-normal2Bscan-vector/<int:scan_fid>/', normal2bscan_update_view, name='normal2bscan_update_page'),
    path('delete-disease2bscan-vector/<int:scan_fid>/', disease2bscan_delete_view, name='disease2bscan_delete_page'),
    path('delete-normal2Bscan-vector/<int:scan_fid>/', normal2bscan_delete_view, name='normal2bscan_delete_page'),
